...
The choice of metric is not free: for each benchmark it is fixed by convention, by the label
structure (single- vs.\ multi-label), and on OGB by the official evaluator. Table~\ref{p1:tab:metrics}
collects the pairing that a result must use to be comparable with published numbers.
