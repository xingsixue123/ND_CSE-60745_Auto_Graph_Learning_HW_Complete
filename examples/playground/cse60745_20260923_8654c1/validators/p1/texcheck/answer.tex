...
\caption{The scalar metrics of \texttt{comparison\_table()}, mean over seeds
...
small and the buckets are $4$--$16\times$ smaller than the full split, so individual cells
