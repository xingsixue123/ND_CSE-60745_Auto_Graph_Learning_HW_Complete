\section*{Part B -- Graph Essentials and Measures (70 pts): Q5}
...
\subsection*{Q5(a): Eigenvector centrality (10 pts)}
...
\bottomrule
\end{tabular}
\caption{Q5(a): the ten nodes with the largest eigenvector centrality.}
\label{p3:tab:eig}
\end{table}
...
($\lambda_{\max}=8.7622$, versus at most $3.9193$ for every other component), so all
...
\subsection*{Q5(b): Katz centrality (10 pts)}
...
\bottomrule
\end{tabular}
\caption{Q5(b): the ten nodes with the largest Katz centrality.}
\label{p3:tab:katz}
\end{table}
...
\subsection*{Q5(c): Average clustering coefficient and average Jaccard similarity (10 pts)}
...
\[
  \bar{J} \;=\; 0.041304 .
\]
The value is small because $21{,}167$ of the $26{,}377$ edges ($80.2\%$) join two
