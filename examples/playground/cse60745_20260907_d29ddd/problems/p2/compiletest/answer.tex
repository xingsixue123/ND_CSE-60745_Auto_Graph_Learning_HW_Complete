\section{Q3--Q4: Graph Creation and Graph Essentials}
...
index $1$ was taken, i.e.\ \texttt{sorted(nx.connected\_components(G),
key=len, reverse=True)[1]}. The ten largest component sizes are
\[
